...
Immersion means spending hours every day with Italian made for Italians. You watch it, listen to it and read it, and you look up what you don't understand. This page answers the questions that come up once you start. If you haven't set up your tools yet, go to [Setup](setup.md) first.
...
- Anki reviews, first thing, before anything else. They take 20 to 40 minutes once your deck is mature.
- Active immersion, where you give Italian your full attention. Aim for at least an hour.
- Passive immersion, which is Italian audio playing while you do something else. Stack as much as you can.

On a bad day, do your reviews and one episode of something easy. That counts. The goal is to never have a zero day, because a zero day makes the next one easier to skip.

Count total hours, not streaks. A learner who logs 1,000 hours of Italian input understands far more than one who logs 300, whatever method each one used. Keep a simple spreadsheet or a tracking app if numbers motivate you.

## Does immersion get easier?

Yes, and faster than you expect. The first month is the hardest part of the whole process. You will watch a scene three times and catch a handful of words. That is normal, and it passes.
...
No. They're slow. A textbook spends a chapter teaching what an hour of immersion shows you twenty times in context. It gives you invented dialogues about train tickets when you could be watching a real series.
...
- Slice-of-life series, sitcoms and reality TV use everyday vocabulary and repeat it often. Crime dramas and legal shows use more specialised words.
- Children's and young-adult content is easier, but only if you like it.
- YouTube channels aimed at Italian learners are a good bridge in your first months. Leave them once native content becomes manageable.
- Podcasts with one or two speakers talking about a single topic are easier than radio phone-ins with crosstalk.
- Contemporary novels are easier than the classics. Save Manzoni for later.

If you understand less than half of something even with subtitles, park it and come back in a few months. The [Recommendations](recommendations.md) page has a starter list grouped by medium and difficulty.

## What about regional accents and dialects?

Learn standard Italian and let accents come to you. Standard Italian is what you hear on the national news, in most dubbed media and in most fiction set nowhere in particular. It is based on Florentine and is the version every Italian understands.

In practice, almost nobody speaks it without an accent. A Roman, a Milanese and a Neapolitan all speak Italian, but each has a distinct rhythm, vowel system and set of local words. Those differences are accents, and you'll pick them up through exposure. Don't try to choose one. Your own accent will drift toward whatever you listen to most, and any of them is fine.

The dialects are a different matter. Neapolitan, Sicilian, Venetian, Piedmontese, Sardinian and many others are separate Romance varieties that developed from Latin alongside Florentine, not accents of it. A speaker of standard Italian can't follow a conversation in broad Sicilian without learning it. Most Italians today speak standard Italian with a regional accent and switch into dialect with family or friends, if they speak it at all.

You will meet dialect in Italian film and TV. *Gomorra*, the Sky series set in Naples, has so much Neapolitan that Italian viewers watch it with Italian subtitles. *Il commissario Montalbano* mixes Sicilian words into its Italian. Don't mine dialect words into your deck unless you want to learn that dialect. Enjoy the show, read the subtitles, and move on. If you fall for Naples or Palermo later, the dialect can be your next project.

## Is Italian-dubbed media good immersion?

Yes. Italy dubs nearly all foreign films and TV, and it does it well. Dubbing is a respected craft there, with dedicated voice actors who voice the same Hollywood stars for decades. For a learner this means every show you already know in English exists in Italian, so you can rewatch a favourite series and follow it on the first try.

Dubbed media has two limits. First, the dialogue comes from translators who have to match lip movements, so some lines sound stiffer than real speech. Second, dubbing flattens accents into neutral standard Italian. You won't hear how people in Bari or Turin actually talk.

Use both. Dubbed shows you know are the easiest native input you can find, which makes them perfect for your first few hundred hours. Mix in Italian-made productions as soon as you can follow them, because those carry the jokes, slang and rhythm of real Italian. Check the audio menu on streaming services you already pay for, since many offer an Italian track.
...
Not at the start. A tutor can't give you the thousands of hours of input you need, and paying someone to hear you struggle through sentences you can't yet build is a poor use of money.

A tutor becomes worth it once you understand most of what you hear and want to start speaking. At that point, pick a conversation tutor, not a teacher with a syllabus. You want someone who talks with you about things you care about, lets you do most of the talking, and corrects the mistakes you repeat. Platforms like italki and Preply list many Italian tutors, so try a few trial lessons and keep the one you enjoy talking to.

Group classes are the weakest option. You spend most of the hour listening to other learners' mistakes. Take one if you want the social side or need a structure you can't make yourself, but don't count it as immersion.
...
- Read things you'd read anyway. News about your hobby, Wikipedia pages on topics you like, Italian Reddit threads.
- Don't look up every word. If you get the gist of a sentence, move on. Look up a word when it blocks the meaning or when you see it for the third time.
- Read along with audio. An audiobook together with its ebook doubles as listening practice and sets a pace for you.
- Reread. A short story you read twice is faster and more enjoyable the second time, and the words stick better.

Italian spelling is regular, so you don't have a writing system to learn as well as the language. Your reading speed depends almost entirely on vocabulary. Every word you learn makes the next page faster. After a few thousand words, you'll find you read Italian at a comfortable pace without having worked on speed at all.

## Is mining words from a dictionary worth it?

No. Mine from immersion.

A word you meet in a show or a book comes with a sentence, a situation and a memory. When the card comes up in Anki, you remember the scene, and the word sticks. A word pulled from a dictionary or a frequency list has none of that. It's harder to remember, and you might not see it again for months.

The exception is a pre-made beginner deck of the most common few thousand words. It gets you to the point where native content is usable, and the words are common enough that you'll meet them daily. Once you finish it, stop adding cards from lists. From then on, every card should come from something you watched or read.
